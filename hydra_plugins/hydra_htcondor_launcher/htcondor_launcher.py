...
class BaseHTCondorLauncher(Launcher):
    _EXECUTOR = "abstract"
    ...
    def launch(
        ...
        params = self.params
        # build executor
        init_params = {"folder": self.params["htcondor_folder"]}
        ...
        init_keys = specific_init_keys | {"htcondor_folder"}

        print(init_params)
        print(init_keys)

        executor = htcondor.AutoExecutor(cluster=self._EXECUTOR, **init_params)
...
class HTCondorLauncher(BaseHTCondorLauncher):
    _EXECUTOR = "htcondor"
